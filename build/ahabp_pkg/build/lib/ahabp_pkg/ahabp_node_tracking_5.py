...
#    print("The date is: ", date)
    #timestr = time.strftime("%m%d%-y-%H:%M:%S")         # Create time string for output files - to keep things organized
    timeStrExamp = timeString()
    print("The timestr is: ", timeStrExamp)
